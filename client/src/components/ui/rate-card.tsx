...
export function RateCard({ rate, className }: RateCardProps) {
  ...
  return (
    <Card className={cn("shadow-md overflow-hidden border-t-4 aspect-square", 
      ...
      className)}>
      <CardContent className="p-3 bg-gradient-to-br from-white to-gray-50 h-full flex flex-col justify-between">
        ...
        <div className="flex items-baseline justify-center mt-1.5 bg-white p-2 rounded-md shadow-sm">
          <span className="text-sm mr-0.5 text-gray-700">₹</span>
          <span className="text-xl font-bold">{rate.current.toLocaleString()}</span>
